    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel viewModel)
        {
            ...
            if (user != null)
            {
                ...
                {
                    ViewBag.errorMessage = "You need to confirm your email first.";
                    return View("Error");
                }
            }

            var result = await SignInManager.PasswordSignInAsync(viewModel.Username, viewModel.Password, viewModel.RememberMe, shouldLockout: true);
            switch (result)
            {
        ...
        public async Task<ActionResult> Register(RegisterViewModel viewModel)
        {
            if (ModelState.IsValid)
            {
                ...
                if (!userExistInDb)
                {
                    ...
                    if (result.Succeeded)
                    {
                        await UserManager.AddToRoleAsync(newUser.Id, "Default User");
                        ...
                        using (StreamReader reader = new StreamReader(Server.MapPath("~/Views/Template/AccountConfirmation.cshtml")))
                        {
                        ...
                        await UserManager.SendEmailAsync(newUser.Id, subject: "Confirm your account", body: body);
        ...
        public async Task<ActionResult> ConfirmEmail(string userId, string code)
        {
            ...
            {
                ViewBag.errorMessage = "You're not supposed to enter here.";
                return View("Error");
            }
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await UserManager.SendEmailAsync(user.Id, subject: "Reset Password", body: body);
